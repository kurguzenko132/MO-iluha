...
Финальная правка конверта:
- текст больше не выезжает на заголовок;
- письмо отображается отдельной карточкой над конвертом;
- закрытый конверт остаётся аккуратно внизу;
- адаптировано под широкий экран и телефон.
